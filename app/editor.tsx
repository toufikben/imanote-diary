...
export default function EditorScreen() {
  ...
  return <View style={[s.page, { backgroundColor: palette.background }]}>
    ...
    <ScrollView
      contentContainerStyle={[s.content, { paddingBottom: Math.max(insets.bottom, 12) + 168 }]}
      keyboardShouldPersistTaps="handled"
      scrollIndicatorInsets={{ bottom: Math.max(insets.bottom, 12) + 92 }}
    >
