...
export async function syncDailyReminder(settings: DiarySettings, options: { requestPermission?: boolean } = {}): Promise<ReminderSyncResult> {
  ...
  await Notifications.scheduleNotificationAsync({
    content: { title: settings.hideReminderContent ? copy.privateTitle : copy.title, body: settings.hideReminderContent ? copy.privateBody : copy.body, data: { kind: DAILY_REMINDER_KIND } },
    trigger: {
